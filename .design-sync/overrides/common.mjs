// forked from design-sync lib/common.mjs — add VITE_SUPABASE_* placeholder env vars so supabase client initializes without throwing in IIFE mode
...
export const IIFE_IMPORT_META_DEFINE = {
  ...
  // Vinki: include Supabase placeholder vars so supabaseClient.js doesn't call
  // createClient(undefined, undefined) which throws on init in IIFE mode.
  'import.meta.env': '{"MODE":"development","DEV":true,"PROD":false,"SSR":false,"BASE_URL":"/","VITE_SUPABASE_URL":"https://placeholder.supabase.co","VITE_SUPABASE_ANON_KEY":"placeholder-anon-key"}',
};
