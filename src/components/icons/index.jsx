...
function SvgIcon({ children, size = 22, className = '', style = {}, ...rest }) {
  return (
...
export function IconBack(p) {
  return <SvgIcon {...p}><polyline points="15 18 9 12 15 6" /></SvgIcon>
}
...
export function IconMinimize(p) {
  return <SvgIcon {...p}><line x1="5" y1="12" x2="19" y2="12" /></SvgIcon>
}
...
export function IconCheck(p) {
  return <SvgIcon {...p}><polyline points="20 6 9 17 4 12" /></SvgIcon>
}
...
export function IconChevronRight(p) {
  return <SvgIcon {...p}><polyline points="9 18 15 12 9 6" /></SvgIcon>
}
...
const PATHS = {
  ...
  vinki:        <><polyline points="2 4 8 16 12 8" /><polyline points="12 8 16 16 22 4" /></>,
  canvas:       <><path d="M3 7V5a2 2 0 0 1 2-2h2M17 3h2a2 2 0 0 1 2 2v2M21 17v2a2 2 0 0 1-2 2h-2M7 21H5a2 2 0 0 1-2-2v-2" /><rect x="7" y="7" width="10" height="10" rx="1" /></>,
  ...
  link:         <><rect x="2" y="4" width="20" height="16" rx="3" /><path d="M8 10a2 2 0 0 0 2.83.17l2-2a2 2 0 0 0-2.83-2.83L9.29 6.05" /><path d="M11 14a2 2 0 0 0-2.83-.17l-2 2a2 2 0 0 0 2.83 2.83l.7-.71" /></>,
  image:        <><rect x="3" y="3" width="18" height="18" rx="2" /><circle cx="8.5" cy="8.5" r="1.5" /><polyline points="21 15 16 10 5 21" /></>,
  pdf:          <><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><path d="M9 13h1.5a1.5 1.5 0 0 1 0 3H9v-3z" strokeWidth="1.8" /><line x1="13" y1="13" x2="13" y2="16" strokeWidth="1.8" /><path d="M16 13h.5a1.5 1.5 0 0 1 0 3H16v-3z" strokeWidth="1.8" /></>,
  deck:         <><rect x="2" y="6" width="16" height="12" rx="2" /><path d="M6 6V4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-2" /><line x1="7" y1="10" x2="13" y2="10" /><line x1="7" y1="14" x2="11" y2="14" /></>,
  timer:        <><circle cx="12" cy="13" r="8" /><path d="M12 9v4l2.5 2.5" /><line x1="9" y1="2" x2="15" y2="2" /></>,
  move:         <><polyline points="5 9 2 12 5 15" /><polyline points="9 5 12 2 15 5" /><polyline points="15 19 12 22 9 19" /><polyline points="19 9 22 12 19 15" /><line x1="2" y1="12" x2="22" y2="12" /><line x1="12" y1="2" x2="12" y2="22" /></>,
  expand:       <><polyline points="15 3 21 3 21 9" /><polyline points="9 21 3 21 3 15" /><line x1="21" y1="3" x2="14" y2="10" /><line x1="3" y1="21" x2="10" y2="14" /></>,
  face:         <><circle cx="12" cy="12" r="10" /><path d="M8 14s1.5 2 4 2 4-2 4-2" /><line x1="9" y1="9" x2="9.01" y2="9" strokeWidth="2.5" /><line x1="15" y1="9" x2="15.01" y2="9" strokeWidth="2.5" /></>,
  logout:       <><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" /><polyline points="16 17 21 12 16 7" /><line x1="21" y1="12" x2="9" y2="12" /></>,
  leave:        <><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4" /><polyline points="10 17 15 12 10 7" /><line x1="15" y1="12" x2="3" y2="12" /></>,
  ...
  join:         <><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7" /></>,
  star:         <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />,
  heart:        <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />,
  flame:        <path d="M12 2c1 3.5 4.5 5 4.5 8.5a4.5 4.5 0 0 1-9 0C7.5 8 9 6.5 9 4.5c1.5 1 2 2.5 3-2.5z" />,
  search:       <><circle cx="11" cy="11" r="7" /><line x1="21" y1="21" x2="16.5" y2="16.5" /></>,
}

export function Icon({ name, size = 22, strokeWidth = 2, className = '', style = {}, ...rest }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
